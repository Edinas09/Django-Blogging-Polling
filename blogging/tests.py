...
class PostTestCase(TestCase):
    ...
    # python manage.py dumpdata app.blogging --indent 4 > blogging/fixtures/blogging_test_fixture.json
    #  https://docs.djangoproject.com/en/3.1/ref/django-admin/#django-admin-dumpdata
    # python manage.py dumpdata auth.user --indent 4 > blogging/fixtures/blogging_test_fixture.json
